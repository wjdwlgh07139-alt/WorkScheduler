...
{
    /// <inheritdoc />
    public partial class ComplexStructureCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionStudents", x => new { x.LessonSessionId, x.StudentId });
                    table.ForeignKey(
                        name: "FK_SessionStudents_LessonSessions_LessonSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonSessions_Date_TimeSlot",
                table: "LessonSessions",
                columns: new[] { "Date", "TimeSlot" });

            migrationBuilder.CreateIndex(
                name: "IX_LessonSessions_InstructorId",
                table: "LessonSessions",
                column: "InstructorId");
